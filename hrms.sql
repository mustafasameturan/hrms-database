...
VALUES ('Yazılım Geliştirici'),('Aşcı');

DO $$
    DECLARE user_id integer;
BEGIN
	INSERT INTO "public"."users" (email,password) VALUES('mustafasameturan@hotmail.com','123456') RETURNING id INTO user_id;
	INSERT INTO "public"."candidates" (id,first_name,last_name,identity_number,birth_date) VALUES(user_id,'turan','mustafa samet','11111111112','2000-03-27');
END $$;